...
g = {}
with open(os.path.join('..', 'hepdata_converter', 'version.py'), 'rt') as fp:
    exec(fp.read(), g)
...
# of the sidebar.
html_logo = 'hepdata-converter.png'
...
htmlhelp_basename = 'HEPData_converter_namedoc'
...
latex_documents = [
  (master_doc, 'HEPData-Converter.tex', u'HEPData Converter Documentation',
   u'CERN', 'manual'),
]
